...
import ni.org.ics.estudios.cohorte.muestreoanual.service.LactanciaMaternaService;
...
public class LactanciaMaternaController {
    ...
    public @ResponseBody List<LactanciaMaterna> descargarObsequios() {
    ...
    public @ResponseBody String sendMessageJson(@RequestBody LactanciaMaterna[] envio) {
