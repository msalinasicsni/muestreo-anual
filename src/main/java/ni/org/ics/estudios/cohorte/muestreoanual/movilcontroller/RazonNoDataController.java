...
import ni.org.ics.estudios.cohorte.muestreoanual.service.RazonNoDataService;
...
public class RazonNoDataController {
    ...
    public @ResponseBody List<RazonNoData> descargarRazonNoData() {
    ...
    public @ResponseBody String sendMessageJson(@RequestBody RazonNoData[] envio) {
