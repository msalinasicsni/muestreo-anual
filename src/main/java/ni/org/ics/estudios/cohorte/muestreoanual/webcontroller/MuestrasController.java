...
import ni.org.ics.estudios.cohorte.muestreoanual.service.RecepcionBHCService;
import ni.org.ics.estudios.cohorte.muestreoanual.service.RecepcionSeroService;
...
public class MuestrasController {
	...
	public String fetchTodasBHCJSP(Model model) throws ParseException { 	
		...
		List<Muestra> estBhcs = muestraService.getMuestrasBHC();
	...
	public String fetchTodosRojosJSP(Model model) throws ParseException { 	
		logger.debug("Mostrando Muestras en JSP");
		List<Muestra> estRojos = muestraService.getMuestrasRojo();
	...
	public String fetchTodosPbmcsJSP(Model model) throws ParseException { 	
		logger.debug("Mostrando Muestras en JSP");
		List<Muestra> estPbmcs = muestraService.getMuestrasPbmc();
	...
	public String fetchComp1JSP(Model model) throws ParseException { 	
		...
		List<Muestra> bhcEstnoSup = muestraService.getCompBHCEstSupHoy();
		List<Muestra> bhcEstnoLab = muestraService.getCompBHCEstLabHoy();
	...
	public String fetchComp2JSP(Model model) throws ParseException { 	
		...
		List<Muestra> rojoEstnoSup = muestraService.getCompSeroEstSupHoy();
		List<Muestra> rojoEstnoLab = muestraService.getCompSeroEstLabHoy();
	...
	public String fetchComp3JSP(Model model) throws ParseException { 	
		logger.debug("Mostrando Muestras en JSP");
		List<Muestra> pbmcEstnoLab = muestraService.getCompPbmcEstLabHoy();
