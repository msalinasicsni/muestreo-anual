...
public class DocumentosWebController {
    ...
    public @ResponseBody List<Documentos> fetchDocumentosxCodeJson(@RequestParam(value = "codigo", required = true) Integer codigo) throws ParseException {
    ...
    public @ResponseBody List<Documentos> fetchDocumentosxDateJson(@RequestParam(value = "fecha", required = true) String fecha) {
        logger.info("Obteniendo los documentos en JSON");
        List<Documentos> docs = null; 
        Date sdf;
		try {
