...
import ni.org.ics.estudios.cohorte.muestreoanual.service.DatosVisitaTerrenoService;
...
public class DatosVisitaTerrenoController {
    ...
    public @ResponseBody List<DatosVisitaTerreno> descargarDatosVisitaTerreno() {
    ...
    public @ResponseBody String sendMessageJson(@RequestBody DatosVisitaTerreno[] envio) {
