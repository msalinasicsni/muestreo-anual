...
import ni.org.ics.estudios.cohorte.muestreoanual.service.PesoyTallaService;
...
public class PesoyTallaController {
    ...
    public @ResponseBody List<PesoyTalla> descargaPesoyTalla() {
    ...
    public @ResponseBody String sendMessageJson(@RequestBody PesoyTalla[] envio) {
