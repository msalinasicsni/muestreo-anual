...
import ni.org.ics.estudios.cohorte.muestreoanual.service.DatosPartoBBService;
...
public class DatosPartoBBController {
    ...
    public @ResponseBody List<DatosPartoBB> descargaDatosPartoBB() {
    ...
    public @ResponseBody String sendMessageJson(@RequestBody DatosPartoBB[] envio) {
