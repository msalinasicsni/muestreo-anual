...
$(document).ready(function(){
  ...
  setTimeout(function() {noty({text: '<strong>Nuevo ingreso por dengue...</strong>',layout:'topRight',type:'information',timeout:15000});}, 7000);

  setTimeout(function() {noty({text: 'Ha ingresado a La Mascota un niño con signos de dengue severo 36% HTO 120,000 plaquetas... ',layout:'topRight',type:'alert',timeout:13000});}, 9000);
