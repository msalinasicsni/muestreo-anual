...
<body>
						...
						<div class="col-md-12">
							<div class="widget">
								<div class="widget-head">
									<div class="pull-left"><fmt:message key="consentimientos.all" /></div>
							...
							<div class="widget">
								...
								<div class="widget-content">
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<c:forEach items="${conteoReconsentimientos}" var="cons">
											<tr>
												<td><c:out value="${cons[0]}" /></td>
												<td><c:out value="${cons[1]}" /></td>
											</tr>
										</c:forEach>
									</table>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<thead>
											<tr>
												...
												<th><fmt:message key="consentimientos.partef" /></th>
										...
										<c:forEach items="${consentimientos}" var="consentimientos">
											<tr>
												<td><c:out
														value="${consentimientos.consChikId.codigo}" /></td>
												<td><c:out
														value="${consentimientos.consChikId.fechaCons}" /></td>
												<td><c:out value="${consentimientos.parteFDen}" /></td>
												...
												<td><c:out value="${consentimientos.movilInfo.recurso1}" /></td>
											</tr>
										</c:forEach>
									</table>
									<div class="widget-foot"></div>
	...
	<script type="text/javascript">
		$(function() {
			...
			var chikest = [];
			var fechas = [];
			<c:forEach var="conteoReconsentimiento" items="${conteoReconsentimientos}">
				fechas.push([ "${conteoReconsentimiento[0]}" ]);
				chikest.push([ "${conteoReconsentimiento[0]}", "${conteoReconsentimiento[1]}" ]);
			</c:forEach>
