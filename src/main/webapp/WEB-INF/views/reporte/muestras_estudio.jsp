...
<body>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${muestrasEstudio}" var="conteo">
										<tr>
				            ...
				            "aButtons": [
				                         {
				                             ...
				                             "aButtons": [
				                                          ...
				                                          },
				                                          {
				                                              ...
				                                              "sFileName": "muestrasxestudio.csv",
	                    	                                     "sTitle": "Muestras por Estudio",
	                    	                                     "oSelectorOpts": { filter: 'applied', order: 'current' }
				                                          },
				                                          {
				                                              "sExtends": "pdf",
				                                              "sButtonText": "Guardar PDF",
				                                              "sFileName": "muestrasxestudio.pdf",
	    	            	                                     "sTitle": "Informe de Avance de Muestreo Anual 2015",
	    	            	                                     "sPdfMessage": "Muestras por Estudio",
	                    	                                     "oSelectorOpts": { filter: 'applied', order: 'current' },
	                    	                                     "sPdfSize": "letter"
				                                          }
				                                      ]
	...
	$(function() {
		...
		var totfaltan = 0;
		var v = 0;
		<c:forEach var="mBarrio" items="${muestrasEstudio}">
		barrios.push([ "${mBarrio[0]}" ]);
		totales.push([ "${mBarrio[0]}", "${mBarrio[1]}" ]);
		tottotal = tottotal + parseInt("${mBarrio[1]}");
		hechos.push([ "${mBarrio[0]}", "${mBarrio[2]}" ]);
		tothechos = tothechos + parseInt("${mBarrio[2]}");
		faltantes.push([ "${mBarrio[0]}", "${mBarrio[3]}" ]);
		totfaltan = totfaltan + parseInt("${mBarrio[3]}");
