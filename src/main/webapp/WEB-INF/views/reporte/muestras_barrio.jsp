						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${muestrasBarrio}" var="conteo">
										<tr>
				            ...
				            "aButtons": [
				                         {
				                             ...
				                             "aButtons": [
				                                          ...
				                                          },
				                                          {
				                                              ...
				                                              "sFileName": "muestrasxbarrio.csv",
	                    	                                     "sTitle": "Muestras por Barrio",
	                    	                                     "oSelectorOpts": { filter: 'applied', order: 'current' }
				                                          },
				                                          {
				                                              "sExtends": "pdf",
				                                              "sButtonText": "Guardar PDF",
				                                              "sFileName": "muestrasxbarrio.pdf",
	    	            	                                     "sTitle": "Informe de Avance de Muestreo Anual 2015",
	    	            	                                     "sPdfMessage": "Muestras por Barrio",
	                    	                                     "oSelectorOpts": { filter: 'applied', order: 'current' },
	                    	                                     "sPdfSize": "letter"
				                                          }
				                                      ]
