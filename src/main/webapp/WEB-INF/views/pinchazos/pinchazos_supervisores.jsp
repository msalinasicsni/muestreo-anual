...
<body>
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="tubo.pin" /></div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${conteoPinchazos}" var="conteo">
										<tr>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${pinchazos}" var="pinchazo">
										<tr>
											<td><c:out value="${pinchazo.pinId.codigo}" /></td>
											<td><c:out value="${pinchazo.pinId.fechaPinchazo}" /></td>
											<td><c:out value="${pinchazo.lugar}" /></td>
											<td><c:out value="${pinchazo.numPin}" /></td>
											<td><c:out value="${pinchazo.observacion}" /></td>
											<td><c:out value="${pinchazo.username}" /></td>
										</tr>
									</c:forEach>
								</table>
								<div class="widget-foot">
	...
	<script type="text/javascript">
		$(function() {
			...
			var pinchazos = [];
			var fechas = [];
			<c:forEach var="conteo" items="${conteoPinchazos}">
				fechas.push([ "${conteo[0]}" ]);
				pinchazos.push([ "${conteo[0]}", "${conteo[1]}" ]);
			</c:forEach>

			var plot = $.plot("#curve-chart", [ {
				data : pinchazos,
				label : "Mas de 1 pin autorizado"
			}], {
				series : {
