...
<body>
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="rojo.sup" /></div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${conteoRojoSup}" var="conteo">
										<tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			var rojosup = [];
			var fechas = [];
			<c:forEach var="conteo" items="${conteoRojoSup}">
				fechas.push([ "${conteo[0]}" ]);
				rojosup.push([ "${conteo[0]}", "${conteo[1]}" ]);
			</c:forEach>
