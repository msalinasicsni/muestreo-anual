...
<body>
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="pbmc.est" /></div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${estPbmcsTotales}" var="pbmcs">
										<tr>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${estPbmcs}" var="pbmcs1">
										<tr>
											<td><c:out value="${pbmcs1.mId.codigo}" /></td>
											<td><c:out value="${pbmcs1.mId.fechaMuestra}" /></td>
											<td><c:out value="${pbmcs1.pinchazos}" /></td>
											<td><c:out value="${pbmcs1.movilInfo.recurso1}" /></td>
											<td><c:out value="${pbmcs1.movilInfo.recurso2}" /></td>
										</tr>
									</c:forEach>
								</table>
								<div class="widget-foot">
	...
	<script type="text/javascript">
		$(function() {
			...
			var pbmcest = [];
			var fechas = [];
			<c:forEach var="estpbmc" items="${estPbmcsTotales}">
				fechas.push([ "${estpbmc[0]}" ]);
				pbmcest.push([ "${estpbmc[0]}", "${estpbmc[1]}" ]);
			</c:forEach>
