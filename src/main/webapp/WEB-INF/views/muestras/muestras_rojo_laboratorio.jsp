...
<body>
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="rojo.lab" /></div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${conteoRojoLab}" var="conteo">
										<tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			var rojolab = [];
			var fechas = [];
			<c:forEach var="conteo" items="${conteoRojoLab}">
				fechas.push([ "${conteo[0]}" ]);
				rojolab.push([ "${conteo[0]}", "${conteo[1]}" ]);
			</c:forEach>
