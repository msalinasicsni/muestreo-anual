...
<body>
					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="bhc.sup" /></div>
						...
						<div class="widget">
							...
							<div class="widget-content">
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<c:forEach items="${conteoBHCSup}" var="conteo">
										<tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			var bhcsup = [];
			var fechas = [];
			<c:forEach var="conteo" items="${conteoBHCSup}">
				fechas.push([ "${conteo[0]}" ]);
				bhcsup.push([ "${conteo[0]}", "${conteo[1]}" ]);
			</c:forEach>
