					...
					<div class="col-md-12">
						<div class="widget">
							<div class="widget-head">
								<div class="pull-left"><fmt:message key="temp.lab" /></div>
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<thead>
										...
										<c:forEach items="${temps}" var="temps">
											<tr>
												<td><c:out
														value="${temps.tempLabId.fechaTempLab}" /></td>
												<td><c:out value="${temps.tempLabId.horaTempLab}" /></td>
